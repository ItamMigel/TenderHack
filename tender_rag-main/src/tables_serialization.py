...
# from bit14 import bit14
# from src.api_requests import Basebit14Processor, Asyncbit14Processor
# import tiktoken
...
# class TableSerializer(Basebit14Processor):
...
#         results = await Asyncbit14Processor().process_structured_ouputs_requests(
#             temperature=0,
